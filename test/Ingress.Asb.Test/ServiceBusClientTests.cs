...
namespace Ingress.Asb.Test
{
    ...
    public class ServiceBusClientTests
    {
        ...
        string messageContentsStatusZero = "{ \"createdUTC\": \"2020-05-27T15:38:19.208757Z\", \"predictions\": [{\"probability\": 0.016200000420212746, \"tagName\": \"GRASS\"}, {\"probability\": 0.00032017999910749495, \"tagName\": \"GRAVEL\" }, {\"probability\": 0.79594802856445313, \"tagName\": \"SNOW\" }, { \"probability\": 0.18753175437450409, \"tagName\": \"TARMAC\" } ], \"position\": { \"status\": \"0\", \"accuracy\": \"0.700000\", \"latitude\": \"0.0\", \"longitude\": \"0.0\", \"angle\": \"38.700000\" } }";
        ...
        [TestMethod]
        public async Task TestThatServiceBusClientDoesNotSendAnyRequestWhenPositionStatusZero()
        {
            // Arrange
            ...
            // Act
            await messageHandlerFunc(createMessageFromBody(messageContentsStatusZero), CancellationToken.None);
